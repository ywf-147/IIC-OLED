...
static unsigned char table_week[12] = {0, 3, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5}; //月修正数据表
/*********************************************************************************************************
** 函数名称:GetWeek
...
static void GetSkyEarth(unsigned int year, unsigned char *p)
{
    ...
    *p = x;			//甲乙丙丁戊己庚辛壬癸子丑寅卯辰巳午未申酉戌亥
}
static unsigned char sky[][3] =  {"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸",};
static unsigned char earth[][3] = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥",};
static unsigned char monthcode[][3] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊",};
static unsigned char nongliday[][3] = {"初", "十", "廿", "三",};
...
/*
    ...
    不是很清楚的朋友可给我发EMAIL
*/
static unsigned char YearMonthBit[] =
{
    0x4E, 0xA6, 0x99,		//2000
    0x9C, 0xA2, 0x98,		//2001
    0x80, 0x00, 0x18,		//2002
...
static char JieQiStr[][5] = //以公历日期先后排序
{
    /*  名称        角度    公历日期     周期 */
    "小寒",     //285     1月 6日
    "大寒",     //300     1月20日    29.5天
...
static unsigned char MonthDayMax[] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31,};
/*********************************************************************************************************
** 函数名称:GetJieQiStr
